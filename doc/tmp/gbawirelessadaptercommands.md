...
|       ...       ...         ;/                                        |
|       8000                                                            |
| 0000h 9966rraah   ;-recv ack (aa=cc+80h), and num response_words (rr) |
|       80000000? <reply01>   ;\                                        
...
All command/param/reply transfers should be done at Internal Clock
(except, Response Words for command 25h,27h,35h,37h should use External
Clock).
