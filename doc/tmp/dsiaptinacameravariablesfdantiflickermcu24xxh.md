...
|       2403h                                                           |
| 1  FD_WINDOW_HEIGHT          FlickerMeasurementWindowHeight (def=04h) |
|                                                                       |
|               0-5  Flicker measurement window height in rows (0..3Fh) |
|                    6-7  Unspecified                                   |
|       2404h                                                           |
|    1  FD_MODE                   Flicked Detection switches/indicators |
...
|       2                                                               |
| 408h   1  FD_SEARCH_F1_50           Search F1 50Hz  (0..FFh, def=33h) |
|       2                                                               |
| 409h   1  FD_SEARCH_F2_50           Search F2 50Hz  (0..FFh, def=35h) |
|       2                                                               |
| 40Ah   1  FD_SEARCH_F1_60           Search F1 60Hz  (0..FFh, def=29h) |
|       2                                                               |
| 40Bh   1  FD_SEARCH_F2_60           Search F2 60Hz  (0..FFh, def=2Bh) |
...
|       2410h                                                           |
| 1  FD_MIN_AMPLITUDE          Ignore Signals below Min (0..FFh, def=5) |
|       2411h                                                           |
| 2  FD_R9_STEP_F60_A          60HzA (def=0D4h) ;\Minimal Shutter Width 
|       2413h                                                           |
| 2  FD_R9_STEP_F50_A          50HzA (def=103h) ; Steps for 60Hz/50H AC |
|       2                                                               |
| 415h   2  FD_R9_STEP_F60_B          60HzB (def=09Dh) ; in Context A/B |
|                                                                       |
