...
|       for i=1 to nr-1                                                 |
|         X0                                                            |
- |     = RK[i*4+0] xor scatter32(FT,Y0,Y1,Y2,Y3)  -or-  (RT,Y0,Y3,Y2,Y1) |
|         X1                                                            |
- |     = RK[i*4+1] xor scatter32(FT,Y1,Y2,Y3,Y0)  -or-  (RT,Y1,Y0,Y3,Y2) |
|         X2                                                            |
- |     = RK[i*4+2] xor scatter32(FT,Y2,Y3,Y0,Y1)  -or-  (RT,Y2,Y1,Y0,Y3) |
|         X3                                                            |
- |     = RK[i*4+3] xor scatter32(FT,Y3,Y0,Y1,Y2)  -or-  (RT,Y3,Y2,Y1,Y0) |
|         Y0=X0, Y1=X1, Y2=X2, Y3=X3                                    |
- |       [dst+00                                                         |
- | h] = RK[nr*4+0] xor scatter8(FSb,Y0,Y1,Y2,Y3) -or-  (RSb,Y0,Y3,Y2,Y1) |
- |       [dst+04                                                         |
- | h] = RK[nr*4+1] xor scatter8(FSb,Y1,Y2,Y3,Y0) -or-  (RSb,Y1,Y0,Y3,Y2) |
- |       [dst+08                                                         |
- | h] = RK[nr*4+2] xor scatter8(FSb,Y2,Y3,Y0,Y1) -or-  (RSb,Y2,Y1,Y0,Y3) |
- |       [dst+0C                                                         |
- | h] = RK[nr*4+3] xor scatter8(FSb,Y3,Y0,Y1,Y2) -or-  (RSb,Y3,Y2,Y1,Y0) |
+-----------------------------------------------------------------------+
```
