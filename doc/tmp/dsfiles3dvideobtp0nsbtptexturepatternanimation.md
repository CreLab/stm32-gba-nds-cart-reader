...
Allows to use different textures/palettes in each frame (ie. to use a
short \"movie clip\" instead of a static \"bitmap\" as texture).
...
|       0                                                               |
| 04h 2     Unknown (can be 08h or 32h)   ;rather NOT Number of Frames? |
...
|       00Ch .                                                          |
| .    Dict (with 8-byte Track entries; includes offsets to Key Frames) |
|       ...  X*4   Key Frames                                           |
...
|       004h 2                                                          |
|     Unknown (1000h or 00F5h) (maybe loop flags and/or framerate etc.) |
