...
+-----------------------------------------------------------------------+
|      _________                                                        |
| ___________________ DMAC Debug Registers ____________________________ |
|                                                                       |
...
**10xxxD08h - DBGINST0 - Debug Instruction-0 (W)
- (code\[2\]+ch+thread)**
...
|       db 01h,<                                                        |
| chn>,DMA_KILL,0,0,0,0,0      ;<-- kill channel (eg. after fault/hang) |
+-----------------------------------------------------------------------+
```
