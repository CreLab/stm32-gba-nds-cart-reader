...
|       0..2312                                                         |
| bytes   Frame Body (in practice, network MTU is circa 1500 bytes max) |
|                                                                       |
...
|       4-7  S                                                          |
| ubtype            (see next chapters) (meaning depends on above Type) |
|       8    To Distribution System (ToDS)                              |
|       9    From Distribution System (FromDS)                          |
|       10   More Fragments                                             |
|       11   Retry                                                      |
|       12   Po                                                         |
| wer Managment    (0=Active, 1=STA will enter Power-Safe mode after..) |
|       13   More Data                                                  |
...
|       1     Lo                                                        |
| cal Flag (0=Universally Administered Address, 1=Locally Administered) |
...
|       00                                                              |
| 16 56 xx xx xx  NDS-Consoles (Newer NDS-Lite with firmware v6 and up) |
|       00 23                                                           |
| CC xx xx xx  DSi-Consoles (Original DSi with early mainboard; nocash) |
...
|       03                                                              |
|  09 BF 00 00 03  NDS-Multiboot: host to client (acknowledges replies) |
