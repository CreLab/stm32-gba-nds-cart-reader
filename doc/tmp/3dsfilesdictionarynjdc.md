...
NJDC files contain dictionaries (maybe for spellchecking?), NJDC files
are found in:

```
+-----------------------------------------------------------------------+
|      Shared Da                                                        |
| ta Archives: Dictionary (RomFS:\..\*.a) ;for console/region languages 
|      Syste                                                            |
| m Applets: 3DS Browser applet (RomFS:\iwnn\..\*.a) ;for all languages 
+-----------------------------------------------------------------------+
```


**Dictionary Format**
The files contain a header and several large tables. The header size
(and the location/presence of the header entries) varies from file to
file; possibly depending on some header flags?
...
+-----------------------------------------------------------------------+
|       0                                                               |
| 00h 1    String Length in bytes (always even, since chars are UTF-16) |
