...
+-----------------------------------------------------------------------+
|       0-3                                                             |
| Standard SDIO Function Interface Code                             (R) |
|       4-5                                                             |
| Reserved for Future                                               (-) |
|       6                                                               |
| Code Storage Area (CSA) Supported                   (0=No, 1=Yes) (R) |
|       7     Co                                                        |
| de Storage Area (CSA) Enable   (0=Block reads/writes, 1=Enable) (R/W) |
|       8-15                                                            |
| Extended standard SDIO Function interface code  (when bit0-3=0Fh) (R) |
+-----------------------------------------------------------------------+
```
...
|       9h:0                                                            |
| 0h = SDIO Bluetooth Type-A Alternate MAC PHY (AMP) standard interface |
...
+-----------------------------------------------------------------------+
|       0                                                               |
| Support Power Selection                             (0=No, 1=Yes) (R) |
|       1     En                                                        |
| able Power Selection        (0=Normal Current, 1=Lower Current) (R/W) |
|       2-3                                                             |
| Reserved for Future                                               (-) |
|       4-7   Po                                                        |
| wer State                                                       (R/W) |
...
**0:00n09h-00n0Bh - FBR(n): Pointer to Card Information Structure
(CIS)**

```
+-----------------------------------------------------------------------+
|       0-16                                                            |
| Pointer to Function(n)'s Card Information Structure (Function CIS)(R) |
|       17-23                                                           |
...
+-----------------------------------------------------------------------+
|       0-23  Po                                                        |
| inter to CSA memory (incremented after CSA data read/write)     (R/W) |
+-----------------------------------------------------------------------+
```


**0:00n0Fh - FBR(n): Code Storage Area (CSA) Data \"Window\" (R o
R/W)**

```
+-----------------------------------------------------------------------+
|       0-7   Da                                                        |
| ta (to/from auto-incrementing CSA Address) (R for ROM, R/W otherwise) |
+-----------------------------------------------------------------------+
```
...
+-----------------------------------------------------------------------+
|       0-15  CM                                                        |
| D53 Block size for Function(n)          (0001h..0800h) (0=None) (R/W) |
+-----------------------------------------------------------------------+
```
