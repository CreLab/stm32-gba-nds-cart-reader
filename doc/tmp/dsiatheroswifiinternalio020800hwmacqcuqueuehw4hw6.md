...
- **ATH:020800h..020824h - MAC_QCU_TXDP\[0..9\] ak
MAC_DMA_Q(0..9)\_TXDP**

```
+-----------------------------------------------------------------------+
|       0-31                                                            |
|    DATA  ...   unspecified     ;MAC Transmit Queue descriptor pointer |
+-----------------------------------------------------------------------+
```


**ATH:020840h - MAC_QCU_TXE aka MAC_DMA_Q_TXE - MAC Transmit Queue
enable (R)**
**ATH:020880h - MAC_QCU_TXD aka MAC_DMA_Q_TXD - MAC Transmit Queue
disable**
...
- **ATH:0208C0h..0208E4h - MAC_QCU_CBR\[0..9\] ak
MAC_DMA_Q(0..9)\_CBRCFG**
...
- **ATH:020900h..020924h - MAC_QCU_RDYTIME\[0..9\] ak
MAC_DMA_Q(0..9)\_RDYTIMECFG**

```
+-----------------------------------------------------------------------+
|       0-23                                                            |
| CBR interval (us)      (DURATION)       ;\MAC ReadyTime configuration 
|       24    CBR enable             (EN)             ;/                |
+-----------------------------------------------------------------------+
```


**ATH:020940h - MAC_QCU_ONESHOT_ARM_SC aka
MAC_DMA_Q_ONESHOTMAC_DMAM_SC - Set**
**ATH:020980h - MAC_QCU_ONESHOT_ARM_CC aka
MAC_DMA_Q_ONESHOTMAC_DMAM_CC - Clr**
...
- **ATH:0209C0h..0209E4h - MAC_QCU_MISC\[0..9\] ak
MAC_DMA_Q(0..9)\_MISC**
...
|       9                                                               |
|  Enable TXE cleared on ReadyTime expired or VEOL (TXE_CLR_ON_CBR_END) |
|       10    CBR expired counter reset (MMR_CBR_EXP_CNT_CLR_EN)        |
|       11                                                              |
|   FR_ABORT_REQ_EN         DCU frame early termination request control |
+-----------------------------------------------------------------------+
```
...
+-----------------------------------------------------------------------+
|       0-1                                                             |
| FR_PEND: Pending Frame Count (R)        ;\MAC Misc QCU status/counter 
