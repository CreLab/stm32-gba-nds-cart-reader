...
|       02100                                                           |
| 0h - WMAC DCU             ; (not defined in hw2.0 source code though) |
...
|       01A000                                                          |
| sth (00 01 0E 00, 00 01 0E 00)                        ;\MBOX:HOST_IF? 
|       01B000 sth (--crash-- at 01B00x)                             ;/ |
|       0                                                               |
| 1C000 sth (00 00 14 00, D8 48 45 0E)                        ;-ANALOG? |
|       01D000 Deadc0de                                                 |
|                                                                       |
|   020000 sth (00's)                                            ;\DMA? 
...
|  sth (00's)                                            ;\   ;\same as 
|       023                                                             |
| 000 sth (01 00 00 00, 02 00 00 00)                        ;    ;/DMA? |
|                                                                       |
|     024000 sth (00's)                                            ; ?? |
|       025000 sth (00's)                                            ;  |
|       026000 sth (00's)                                            ;  |
|       027000 sth (00's)                                            ;/ |
|       028000                                                          |
|  sth (<--- mac addr ---> 86 38)            ;\MAC_PCU?     mac_pcu.h ? 
|       029000 sth (14 E1 38 8A, 80 73 00 00)            ;/          ;\ 
|       02A000                                                          |
| sth (00's)                                            ; BB at 29800h? |
|       02B000 sth (00's)                                            ;/ |
|       02C000 sth (00's)                                            ;- |
|       02D000 sth (00's)                                            ;- |
|       02E000 sth (00's)                                            ;- |
...
|       090000 004F1B74        ;                                        |
|       0A000                                                           |
- | 0 004F1B74        ; mirror of ROM word at [0F3FF8] (second-last-word) |
|       0B0000 004F1B74        ;                                        |
|       0C0000 004F1B74        ;                                        |
|       0D0000 004F1B74        ;/                                       |
|                                                                       |
