...
After writing ARM7_CNT, apply the mode value by writing
...
**10018110h - ARM7_RTC_BCD_DATE (R=Latched Read value, W=Written
value)**
...
Ghosting seems to be an alpha value for blending the picture with the
