...
For jap/ori, 9Fxxh isn\'t forwards compatible with jap/plus, so it\'d b
better to check joypad via IoRead.
...
+-----------------------------------------------------------------------+
- |       bx [3007                                                        |
- | 5FCh] ;ApiVector ;in: r0=func_no,r1,r2,r3,[sp+0],[sp+4],[sp+8]=params |
...
specified. Many API functions have no effect until the next Wait
occurs.
...
|       RST0_0Fh N/A (bx 0)                                             |
|       RST0_10                                                         |
| h LoadSystemBackground, A number of background (1..101), E bg# (0..3) |
...
|       RST0_2Ch  (?)                                                   |
|       RST0_2Dh                                                        |
|  LoadCustomBackground, A bg# (0..3), DE pointer to struct_background, |
|                                                                       |
...
|       RST0                                                            |
| _66h SetSpriteVisible, HL=sprite handle, E=(0=not visible, 1=visible) |
...
|       RST0_                                                           |
| 7Eh SetBackgroundPalette, HL=src_addr, DE=offset, C=num_colors (1..x) |
|       RST0_7Fh GetBackgroundPalette(a,b,c)                            |
|       R                                                               |
| ST0_80h SetSpritePalette, HL=src_addr, DE=offset, C=num_colors (1..x) |
...
|       RS                                                              |
| T0_E2h GBA: N/A - Z80: bx hl  ;in: hl=addr, af,bc,de,sp=param, out: a |
...
|       R                                                               |
- | ST8_1Fh GBA: N/A - Z80: ExitRestart;[2032D38h]=a, [00C0h]=0001h  ;a=? |
|       RST                                                             |
| 8_20h GBA: N/A - Z80: WaitJoypad ;wait until joypad<>0, set hl=joypad |
...
|       (the                                                            |
|  renumbered functions can be theoretically used on japanese/original) |
|                                                                       |
...
|       RST8_32h                                                        |
- |  (ori: RST8_30h)  BrightnessHalf   ;[4000050h]=00FFh,[4000054h]=0008h |
- |       RST8_33h (ori: RST8_31h)  BrightnessNormal ;[4000050h]=0000h    |
|       RST8_34h (ori: RST8_32h)  N/A (bx lr)                           |
|       RST8_35h (ori: RST8_33h)   (?)                                  |
|       RST8_36                                                         |
- | h (ori: RST8_34h)  ResetTimer ;[400010Ch]=00000000h, [400010Eh]=A+80h |
...
|       (ca                                                             |
| n be used to tweak jap/ori to start GBA-code from inside of Z80-code) |
|       (                                                               |
