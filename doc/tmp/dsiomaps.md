...
|       4000                                                            |
| 004h  2    2D Engine A+B - DISPSTAT - General LCD Status (Read/Write) |
|                                                                       |
...
|       4                                                               |
| 00006Ch  2    2D Engine A - MASTER_BRIGHT - Master Brightness Up/Down |
+-----------------------------------------------------------------------+
```
...
|       4                                                               |
| 0002A8h  8  DIVREM_RESULT - Division Remainder (=Numer MOD Denom) (R) |
...
|       40                                                              |
| 0106Ch  2    2D Engine B - MASTER_BRIGHT - 16bit - Brightness Up/Down |
+-----------------------------------------------------------------------+
```
...
|       4100010h                                                        |
|   4    Gamecard bus 4-byte data in, for manual or dma read (R) (or W) |
+-----------------------------------------------------------------------+
```
...
|       4100000h  4   IPCFIFORECV - IPC Receive Fifo (R)                |
|       4100010                                                         |
| h  4   Gamecard bus 4-byte data in, for manual or dma read (R) (or W) |
+-----------------------------------------------------------------------+
```
...
|       48                                                              |
| 08000h  ..  Wifi WS1 Region (32K) (mirror of above, other waitstates) |
+-----------------------------------------------------------------------+
```
...
+-----------------------------------------------------------------------+
|       380                                                             |
| FFC0h  4   DSi7 IRQ IF2 Check Bits (hardcoded RAM address) (DSi only) |
