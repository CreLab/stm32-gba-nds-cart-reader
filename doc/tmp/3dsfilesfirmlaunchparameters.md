...
structure at FCRAM+0 if CFG_BOOTENV is zero. The ARM9 kernel writes some
values about the boot environment to AXI WRAM during init to enable
this.
Note: it seems NATIVE_FIRM ARM11-kernel didn\'t parse this during boo
until 3.0.0-X?
...
|       4                                                               |
| 38h 4    The kernel checks this field for value 0xFFFF, if it matches |
...
|       480h                                                            |
|  20h  Can be set via buf1 for APT:SendDeliverArg/APT:StartApplication |
|       4A0h 10h  Can be set by NSS:SetWirelessRebootInfo               |
|       4B0h                                                            |
| 14h  SHA1-HMAC across banner for TWL/NTR titles ;NSS:SetTWLBannerHMAC |
|       4C4h ..   unknown/unspecified                                   |
|                                                                       |
|  500h 40h  This is used by APT:LoadSysMenuArg and APT:StoreSysMenuArg |
|       540h ..   unknown/unspecified                                   |
|       D50h 20h                                                        |
|   WlFirm info (same as DSi 20005E0h)  ;nice, but lacks type1/4/5 info |
...
|                         structure is set.                             |
|       +01h                                                            |
|     3       Setting bit0 here enables overriding the FIRM_* fields in |
...
|       003                                                             |
| h 1    SecureInfo Region         (pseudo BlkID=00140000h in LGY FIRM) |
|       004                                                             |
| h 0Fh  SecureInfo Serial/Barcode (pseudo BlkID=00140001h in LGY FIRM) |
...
|       0F8h                                                            |
| 20h  Config BlkID=00050004h LCD Power saving mode (ABL) (read by LGY) |
...
|       28Ah                                                            |
- |  2    CRC16 size flag (0=VariableSize=[28Ch], Nonzero=FixedSize=288h) |
