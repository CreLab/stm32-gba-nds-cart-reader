...
+-----------------------------------------------------------------------+
|       00h                                                             |
|   A_UINT32 4  pollTime                ;Polling time as a factor of LI |
...
|        (l                                                             |
| owThreshold_lowerVal < lowThreshold_upperVal < highThreshold_lowerVal |
...
|       01h  A_                                                         |
| UINT8  1  thresholdAbove1_Val   ;\these parameters seem to be same as 
|       02h                                                             |
|  A_UINT8  1  thresholdAbove2_Val   ; for WMI_SNR_THRESHOLD_PARAMS_CMD |
...
WMI_RSSI_THRESHOLD_VAL values (which are probably meant to occurr in one
of above fields, unclear which one though):
