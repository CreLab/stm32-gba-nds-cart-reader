...
|       008h                                                            |
| 4+4     Footer Entry (RefID=0100h, Offset from Info+8) ;Offs=Near end |
|                                                                       |
| 010h 4+4     List Entry   (RefID=0101h, Offset from Info+8) ;Offs=10h |
|       018h 4       Number of following List Entries                   |
|       01Ch (4+                                                        |
| 4)*N List Entries (RefID=59xxh, Offs from INFO+18h or Offs=FFFFFFFFh) |
...
+-----------------------------------------------------------------------+
|       000                                                             |
| h 4+4     1st Child Entry (RefID=6000h, Offset=8)  ;\these are simply 
|       008h 4+                                                         |
| 4     2nd Child Entry (RefID=5901h, Offset=8)  ; pointing to the next |
|       010h 4+4                                                        |
|      3rd Child Entry (RefID=6000h, Offset=8)  ; child, until reaching |
|                                                                       |
...
|       004h                                                            |
| +N*8 4   Resource ID ? (05000005h, or 05000002h in another CBNK file) |
