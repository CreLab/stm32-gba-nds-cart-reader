...
|       0:0100                                                          |
| 0h..17FFFh  Card Information Structures (Common CIS and Func 1-7 CIS) |
...
+-----------------------------------------------------------------------+
|       n                                                               |
| :00000h..1FFFFh  Registers (seven 128K spaces, one for each function) |
+-----------------------------------------------------------------------+
```
...
+-----------------------------------------------------------------------+
|       CSA:0                                                           |
| 0000h..FFFFFh  16Mbyte FAT12/FAT16 (accessed indirectly via "Window") |
+-----------------------------------------------------------------------+
```
...
|       0:00n09                                                         |
| h 3    FBR(n): Pointer to Card Information Structure (CIS), Lo/Mid/Hi |
|                                                                       |
