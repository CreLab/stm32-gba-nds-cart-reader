...
**SWAV Header (present only in standalone SWAV files) (not in SWAR
archives)**
...
Note: System Flaw has a lot of SWAV files (instead of using SWAR
archives).
...
|       00                                                              |
| 8h 4    Sound Length, in 4-byte units (exluding ADPCM header, if any) |
|                                                                       |
