...
(Binary) CTR Layout, and is similar to the RLYT format used on the Wii.
...
|       00                                                              |
| Ch N*4   Texture Name Offsets (relative to the start of this "array") |
...
|       00Ch N                                                          |
| *4   Material Entry Offsets (relative to the start of this "section") |
+-----------------------------------------------------------------------+
```
