...
|       000h                                                            |
|  4     Flags (20000011h=Normal/5Ch-byte. 20000009h=Cubemap/110h-byte) |
|       004h 4     ID "TXOB"                                            |
...
|       01Ch 4                                                          |
|      OpenTK Texture width  (eg. 10h) rounded up             ; info #1 |
|                                                                       |
...
|       038h                                                            |
| 4     Offset TexSide0    (04h) (self-relative)       ;\normal texture 
|       03Ch 20h                                                        |
|    TexSide0                                       ;/(flags=20000011h) |
|                                                                       |
|   038h 6*4   Offset TexSide0..5 (18h,34h,50h,6Ch,88h,A4h)   ;\cubemap 
|       050h 6*2                                                        |
| 0h TexSide0..5                                    ;/(flags=20000009h) |
|      TexSide(s):                                                      |
|                                                                       |
