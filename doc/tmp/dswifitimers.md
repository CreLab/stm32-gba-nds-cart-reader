...
Triggers IRQ14 (see IRQ14 notes below) when W_US_COMPARE matches
W_US_COUNT.
...
Allows to define the distance between IRQ15 and IRQ14. The setting
...
For using only ONE of the two IRQ14 sources: W_BEACON_COUNT can be
