...
|       PCB: "19                                                        |
| -C046-04, A-7" (top side) and "B-7" and Microchip ",\\" (bottom side) 
|       PCB: white stamp "3104, 94V-0, RU, TW-15"                       |
|       PCB: black stamp "22FDE"                                        |
|       U1 3                                                            |
| 2pin "Freescale 13190, 4WFQ" (MC13190) (2.4 GHz ISM band transceiver) |
|       U2 48pin "Freescale CT3001, XAC0445"  (bottom side)             |
|       X                                                               |
| 3  2pin "D959L4I" (9.5MHz)           (top side) (ca. 19 clks per 2us) |
+-----------------------------------------------------------------------+
```
...
+-----------------------------------------------------------------------+
|       Sticke                                                          |
| r      "N/A"                     vs "Grossosteim P/AGB-A-WA-EUR-2 E3" |
|                                                                       |
|     PCB-markings "19-C046-03, A-1, 3204"   vs "19-C046-04, A-7, 3104" |
|       U1           "CT3000, XAB0425"         vs "CT3001, XAC0445"     |
|       Tran                                                            |
| sistors  One transistor (Q70)      vs Two transistors (both nameless) |
|       U70/U72      U70 "AAG" (6pin)          vs U72 "BMs" (4pin)      |
+-----------------------------------------------------------------------+
```

Purpose of the changes is unknown (either older/newer revisions, or
different regions with different FCC regulations).
