...
CSEQ is usually found inside of CSAR (but can be also a standalone file,
eg. in 3DS Camera Applet, RomFS:\\sound\\csnd.LZ).
...
|       00Ch                                                            |
|  LEN+1   String (ASCII, plus ending 00h) (eg. "SMF_TWL_function_xxx") |
