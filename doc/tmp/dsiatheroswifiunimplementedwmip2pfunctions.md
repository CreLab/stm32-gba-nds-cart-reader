...
+-----------------------------------------------------------------------+
|       0                                                               |
| 0h  A_UINT8  1    config_id;           ;set to one of WMI_P2P_CONF_ID |
|      Wh                                                               |
| en config_id=1=WMI_P2P_CONFID_LISTEN_CHANNEL  ;WMI_P2P_LISTEN_CHANNEL |
|       01h  A_UINT8  1    reg_class;                                   |
|       02h  A_UINT8  1    listen_channel;                              |
|      When                                                             |
| config_id=2=WMI_P2P_CONFID_CROSS_CONNECT   ;WMI_P2P_SET_CROSS_CONNECT |
|       01h  A_UINT8  1    flag;                                        |
|      When                                                             |
|  config_id=3=WMI_P2P_CONFID_SSID_POSTFIX    ;WMI_P2P_SET_SSID_POSTFIX |
- |       01h  A_UINT8  17h  ssid_postfix[WMI_MAX_SSID_LEN-9];            |
|       18h  A_UINT8  1    ssid_postfix_len;                            |
|      W                                                                |
| hen config_id=4=WMI_P2P_CONFID_INTRA_BSS       ;WMI_P2P_SET_INTRA_BSS |
|       01h  A_UINT8  1    flag;                                        |
|      When co                                                          |
| nfig_id=5=WMI_P2P_CONFID_CONCURRENT_MODE ;WMI_P2P_SET_CONCURRENT_MODE |
|       01h  A_UINT8  1    flag;                                        |
|      W                                                                |
| hen config_id=6=WMI_P2P_CONFID_GO_INTENT       ;WMI_P2P_SET_GO_INTENT |
|       01h  A_UINT8  1    value;                                       |
|                                                                       |
