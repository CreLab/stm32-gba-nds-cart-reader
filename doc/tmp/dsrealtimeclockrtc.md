...
Ideally, \<both\> commands and parameters should be transmitte
...
Note: There is only one register shared as \"Selected Frequency Stead
...
Note: The FOUT pin goes to the DSi\'s wifi daughterboard: FOUT must b
