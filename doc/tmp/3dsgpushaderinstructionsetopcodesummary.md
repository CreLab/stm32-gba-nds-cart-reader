...
|       03h                                                             |
|    1    DPH     Dot product on a 3-component and a 4-component vector |
|                                                                       |
...
|       0Fh                                                             |
|      1u   RSQ     Reciprocal of square root of vector's 1st component |
|       10h-11h ?    ?       ?                                          |
|       12h                                                             |
|  1u   MOVA    Move to address register (float to integer) (to "a0" ?) |
|       13h     1u   MOV     Move to register                           |
|       14h-17h ?    ?       ?                                          |
|       18h                                                             |
|    1i   DPHI    Dot product on a 3-component and a 4-component vector |
...
|       24h                                                             |
|    2    CALL    Call (jump to DST, and return after NUM instructions) |
...
|       2Ah                                                             |
|  0    EMIT    Geometry shader only: Emit vertex (or vertex+primitive) |
|       2Bh                                                             |
|      4    SETEMIT Geometry shader only: Configure type/flags for EMIT |
|       2Ch     2    JMPC    Jump if condition is true                  |
|       2Dh     3    JMPU    Jump if BOOL is true                       |
|       2Eh                                                             |
| -2Fh 1c   CMP     Compare X and Y components and Set booleans cmp.x/y |
|                                                                       |
...
|       |_Opcode                                                        |
| ____|__0________________________________________________| 0  ;NoParam |
|       |_                                                              |
| Opcode____|__Dst____|i1_|__Src1_______|__Src2___|______Desc___| 1  ;\ 
|       |_Opco                                                          |
| de____|__Dst____|i2_|__Src1___|______Src2___|______Desc___| 1i ; misc |
|       |_                                                              |
| Opcode____|__Dst____|i1_|__Src1_______|__?______|______Desc___| 1u ;/ |
|       |_O                                                             |
| pcode__|CmpX_|CmpY_|i1_|__Src1_______|__Src2___|______Desc___| 1c CMP |
|       |_Opc                                                           |
| ode____|X|Y|Cnd|________DstOffs________|_?_|__NumInstr_____| 2  ;\JMP 
|       |_Opco                                                          |
| de____|uID____|________DstOffs________|_?_|__NumInstr?____| 3  ;/etc. |
|       |_Opcode                                                        |
| ____|vID|P|W|__?________________________________________| 4  ;SETEMIT |
|       |_Op                                                            |
| c_|__Dst____|i2_|__Src1___|__Src2_______|__Src3___|__Desc___| 5  ;MAD |
|       |_Opc                                                           |
| _|__Dst____|i3_|__Src1___|__Src2___|______Src3___|__Desc___| 5i ;MADI |
+-----------------------------------------------------------------------+
```
