...
__attribute__((always_inline)) static inline void adbus_level_dir_input(void) { GPIOD->BSRR = 1u << 2u << 16u; }

__attribute__((always_inline)) static inline void adbus_level_dir_output(void) { GPIOD->BSRR = 1u << 2u; }

__attribute__((always_inline)) static inline void uabus_level_dir_input(void) { GPIOC->BSRR = 1u << 12u << 16u; }

__attribute__((always_inline)) static inline void uabus_level_dir_output(void) { GPIOC->BSRR = 1u << 12u; }
...
void gba_cart_rom_write_word(uint32_t word_addr, uint16_t data) { gba_cart_rom_write(word_addr, &data, 1); }
...
void gba_cart_sram_write_byte(uint16_t byte_addr, uint8_t data) { gba_cart_sram_write(byte_addr, &data, 1); }
